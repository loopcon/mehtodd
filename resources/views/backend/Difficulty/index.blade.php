    ...
    <div class="row">
        ...
        <div class="d-md-flex d-block  align-items-center justify-content-between mt-2 page-header-breadcrumb">
            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb">
                        <a href="{{ route('difficulty.create') }}"> <button type="button"
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <table id="DifficultyDatatable" class="table table-bordered text-nowrap" style="width:100%">
...
@section('js')
    <script type="text/javascript">
        (function(window, jQuery) {
            ...
            window.LaravelDataTables["DifficultyDatatable"] = jQuery("#DifficultyDatatable").DataTable({
                "serverSide": true,
                "processing": true,
                "pageLength": 10,
                "responsive": true,
        ...
        jQuery('.datatable-form-filter input').on('keyup', function(e) {
            window.LaravelDataTables["DifficultyDatatable"].draw();
            e.preventDefault();
        });
        ...
        $(document).on("click", ".alert-confirm", function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('difficulty.destroy', ':id') }}".replace(':id', id),
                        data: formData,
                        dataType: "json",
                        processData: false,
                        contentType: false,
