                ...
                <div class="card-body">
                    ...
                    <div class="form-group mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('degination', null, ['placeholder' => 'Enter Degination', 'class' => 'form-control mb-2']) !!}
                    ...
                    <div class="form-group mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                {!! Form::textarea('description', null, ['placeholder' => 'Enter Description', 'class' => 'form-control mb-2']) !!}
                        ...
                        <div class="row mt-4">
                            <div class="col-md-2 offset-md-3 mx-auto my-auto">
                                <div class="form-group">
                                    <label>&nbsp;</label>
                                    {!! Form::submit('Add Client', ['class' => 'btn btn-secondary btn-wave form-group']) !!}
