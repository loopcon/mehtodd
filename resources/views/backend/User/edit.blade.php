                ...
                <div class="card-body">
                    ...
                    {{-- <div class="row">
                        ...
                        <div class="col-md-6">
                            {!! Form::select(
                                'user_category_id',
                                $category->pluck('name', 'id')->prepend('Select Profession Type', ''),
                    ...
                    <div class="form-group mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('year_of_experience', $yearOfExperience, $user->year_of_experience, [
                                    'class' => 'form-select',
                                ]) !!}
                    ...
                    <div class="form-group mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('services[]', $service_list, $service, [
                                    'class' => 'form-select',
                    ...
                    <div class="form-group mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                {!! $errors->first('about_sort', '<span class="text-danger">:message</span>') !!}
                                <span class="font-required" role="alert" style="opacity: 0.5;">
                                ...
                                <div class="image">
                                    @if ($user->profile_photo != null)
                                        <img src="{{ asset('uploads/profilephoto/' . $user->profile_photo) }}"
                                            ...
                                            style="max-width: 80%;">
                                    @else
                                        <!-- Display a default image if no profile photo is available -->
                    ...
                    <div class="form-group mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                {!! Form::file('profile_video', ['class' => 'form-control', 'value' => $user->profile_photo]) !!}
                                ...
                                <ul class="list-group">
                                    <div class="row">
                                        <li class="list-group-item professional_section">
                                            @if (count($user_professional_service) != 0)
                                                @foreach ($user_professional_service as $list)
                                                    <div class="row form-group">
                                                        <div class="col-10">
                                                            {!! Form::text('professionaldetalis[]', $list->details, [
                                ...
                                <ul class="list-group">
                                    <div class="row">
                                        <li class="list-group-item education-container">
                                            @if (count($user_education_service) != 0)
                                                @foreach ($user_education_service as $list)
                                                    <div class="row form-group">
                                                        <div class="col-10">
                                                            {!! Form::text('education_detalis[]', $list->details, [
