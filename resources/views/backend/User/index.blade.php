        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-header">
                    ...
                    <div class="col-4 ms-0 ">
                        <select class="form-select" name="drp_professtional" id="professionalFilter">
                            <option value="">-- Select Professional --</option>
                            <option value="1">Sports</option>
                            <option value="2">Kinésithérapie</option>
                        </select>
                    </div>
                </div>
                <div class="card-body">
...
@section('js')
    <script type="text/javascript">
                ...
                "ajax": {
                    data: function(d) {
                        ...
                        d.displayname = jQuery(
                            ...
                            .val();
                        d.professional = jQuery("#professionalFilter").val();
        ...
        jQuery('#professionalFilter').on('change', function(e) {
            window.LaravelDataTables["UserDatatable"].draw();
            e.preventDefault();
        });
