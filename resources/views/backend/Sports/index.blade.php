    ...
    <div class="row">
        ...
        <div class="d-md-flex d-block  align-items-center justify-content-between mt-2 page-header-breadcrumb">
            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb">
                        <a href="{{ route('sports.create') }}"> <button type="button" class="btn btn-outline-secondary btn-wave">
                                Add Sport
                            </button></a>
                    </ol>
                </nav>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <table id="SportsDatatable" class="table table-bordered text-nowrap" style="width:100%">
...
@section('js')
    <script type="text/javascript">
        (function(window, jQuery) {
            ...
            window.LaravelDataTables["SportsDatatable"] = jQuery("#SportsDatatable").DataTable({
                "serverSide": true,
                "processing": true,
                "pageLength": 10,
                "responsive": true,
        ...
        jQuery('.datatable-form-filter input').on('keyup', function(e) {
            window.LaravelDataTables["SportsDatatable"].draw();
            e.preventDefault();
        });
        ...
        $(document).on("click", ".alert-confirm", function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('sports.destroy', ':id') }}".replace(':id', id),
                        data: formData,
                        dataType: "json",
                        processData: false,
                        contentType: false,
