...
@section('content')
            ...
            <div class="physio-profile">
                            ...
                            @if ($user->city && $user->state && $user->country)
                                <div class="row">
                                    <div>
                                        ...
                                        <p class="address-p">{{ $user->city }}, {{ $user->state }},
                                            {{ $user->country }}.</p>
                                    </div>
                                </div>
                            @endif
                ...
                <div class="container">
                    ...
                    <div class="share-video-box" id="tab-share-video-box">
                        ...
                        @if (Auth::check() && Auth::user()->id == $user->id)
                            <div class="row">
                                <a href="javascript:void(0)" class="add-video-btn" id="addVideoLink"
                                    style="background-color: #198FD9;color: #fff;line-height: 50px;width: 15%;text-align: center;border-radius: 10px;margin-left: 75%;">+
    ...
    <div class="modal fade" id="UploadDocumentModel" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2>{{ __('messages.upload_document') }}</h2>
                    <button data-bs-dismiss="modal"><i class="fa-regular fa-circle-xmark"></i></button>
                </div>
                <div class="modal-body">
                    <div class="profile-update-box">
    ...
    <script>
        ...
        function initAutocomplete() {
          ...
          autocomplete.addListener("place_changed", function () {
            ...
            // Loop through address components to extract city, state, and country
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.sharebtn').click(function() {
                ...
                $('.share-video-box').show();
                $('.likedbtn, .lessonbtn').removeClass('share-active');
                $(this).addClass('share-active');
                tabView("#wookmark1");
            });
            ...
            $('.likedbtn').click(function() {
                ...
                $('.share-video-box, .lesson-video-box').hide();
            ...
            $('.lessonbtn').click(function() {
                ...
                $('.share-video-box, .liked-video-box').hide();
                $(this).addClass('share-active');
                $('.sharebtn').removeClass('share-active');
                $('.likedbtn').removeClass('share-active');
                // tabView("#wookmark4");
