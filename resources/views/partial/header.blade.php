                ...
                <div class="header-element">
                    ...
                    <a href="#" class="header-link dropdown-toggle" id="mainHeaderProfile"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="me-sm-2 me-0">
                                <img src="{{ asset('uploads/logo/' . GetSetting('logo')) }}" alt="img" width="32" height="32" class="rounded-circle">
                            </div>
                    ...
                    <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                        ...
                        <li><a class="dropdown-item d-flex" href="{{ route('profile-page.index') }}"><i
                                    class="fa-solid fa-user fs-18 me-2 op-7"></i>Profile</a></li>
                        <li><a class="dropdown-item d-flex" href="{{ route('logout') }}"><i
                                    class="fa-solid fa-right-from-bracket fs-18 me-2 op-7"></i>Log Out</a></li>
                    </ul>
                </div>
