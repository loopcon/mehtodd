...

{
    ...
    public function Store(Request $request)
    {
        ...
        try {
            ...
            $mail_data = [];
            $emails_data  = $request->email;

            Mail::send('email.welcome-mail', $mail_data, function ($message) use ($emails_data) {
                $message->to($emails_data)->subject('Facility registered successfully');
            });
            if ($id) {
